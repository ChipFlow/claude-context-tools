...
### Fixed
- **Skill registration**: SKILL.md now properly registered in plugin.json so Claude Code loads the usage instructions
- Claude can now see guidance on dynamic directory support, MCP tools, and when to restart sessions
